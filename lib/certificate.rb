...
module Api
  class Certificate
    def self.generate_ca(cypher = 2048, ca_key = 'ca-key.pem', ca_cert = 'ca-crt.pem', name, valid_years)
      ...
      self.write_certificate('ca-key.pem', root_key)
      ...
      self.write_certificate('ca-crt.pem', root_ca)
    end
    ...
    def self.generate_certificate(key, name, ca_key = 'ca-key.pem', ca_cert = 'ca-crt.pem', valid_years)
      ...
      root_ca = self.load_certificate(ca_cert)
      root_key = self.load_key(ca_key)
